...
CREATE TABLE "patient_health_info" (
    ...
    CONSTRAINT "patient_health_info_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "patient_health_info_patientId_key" ON "patient_health_info"("patientId");
...
-- AddForeignKey
ALTER TABLE "patient_health_info" ADD CONSTRAINT "patient_health_info_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
