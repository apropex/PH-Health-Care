...
import TableDataHeader from "@/components/shared/table-components/TableDataHeader";
  ...
  return (
    <div className="w-full">
      <div className="flex flex-wrap justify-between items-center py-4 gap-3">
        <div className="flex-1 flex items-center flex-wrap gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <CustomButton variant="outline" icon={ChevronDown} iconRight>
                Columns
              </CustomButton>
            </DropdownMenuTrigger>
        ...
        <Link href={"/dashboard/admin/manage-doctors/create-doctor"}>
          <CustomButton icon={Plus} iconRight variant="outline">
            Create Doctor
          </CustomButton>
        </Link>
      </div>
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        ...
        <div className="space-x-2 flex items-center">
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>
                <SelectLabel>Row sizes</SelectLabel>
